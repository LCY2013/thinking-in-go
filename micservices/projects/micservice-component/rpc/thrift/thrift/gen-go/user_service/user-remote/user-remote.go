...
import (
	...
	"strconv"
	"strings"
	user_service "thrift/thrift/gen-go/user_service"
...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  LoginResponse checkPassword(LoginRequest req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := user_service.NewUserClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "checkPassword":
		...
		value0 := argvalue0
		fmt.Print(client.CheckPassword(context.Background(), value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
