module github.com/LCY2013/thinking-in-go/micro-with-containerization/payment

go 1.18

require (
	github.com/LCY2013/thinking-in-go/micro-with-containerization/common v0.0.0-20230226074003-db985905d46c
