module github.com/LCY2013/thinking-in-go/micro-with-containerization/cart

go 1.18

require (
	github.com/LCY2013/thinking-in-go/micro-with-containerization/common v0.0.0-20230225042550-ab684fb08c8d
