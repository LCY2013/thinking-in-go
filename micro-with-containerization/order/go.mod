module github.com/LCY2013/thinking-in-go/micro-with-containerization/order

go 1.18

require (
	github.com/LCY2013/thinking-in-go/micro-with-containerization/common v0.0.0-20230226040317-2d79294d8f81
