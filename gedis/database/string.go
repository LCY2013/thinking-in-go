...
func execSet(db *DB, args [][]byte) resp.Reply {
	...
	db.addAof(utils.ToMergeCmdLine("set", args...))
...
func execSetNX(db *DB, args [][]byte) resp.Reply {
	...
	db.addAof(utils.ToMergeCmdLine("setnx", args...))
...
func execMSet(db *DB, args [][]byte) resp.Reply {
	...
	db.addAof(utils.ToMergeCmdLine("mset", args...))
...
func execMSetNX(db *DB, args [][]byte) resp.Reply {
	...
	db.addAof(utils.ToMergeCmdLine("msetnx", args...))
...
func execGetSet(db *DB, args [][]byte) resp.Reply {
	...
	db.addAof(utils.ToMergeCmdLine("getset", args...))
...
func execIncr(db *DB, args [][]byte) resp.Reply {
	...
	if bytes != nil {
		...
		db.addAof(utils.ToMergeCmdLine("incr", args...))
...
func execIncrBy(db *DB, args [][]byte) resp.Reply {
	...
	if bytes != nil {
		...
		db.addAof(utils.ToMergeCmdLine("incrby", args...))
...
func execDecr(db *DB, args [][]byte) resp.Reply {
	...
	if bytes != nil {
		...
		db.addAof(utils.ToMergeCmdLine("decr", args...))
		return reply.MakeIntReply(val - 1)
	}
	entity := &database.DataEntity{
		Data: []byte("-1"),
...
func execDecrBy(db *DB, args [][]byte) resp.Reply {
	...
	if bytes != nil {
		...
		db.addAof(utils.ToMergeCmdLine("decrby", args...))
		return reply.MakeIntReply(val - delta)
	}
...
func execAppend(db *DB, args [][]byte) resp.Reply {
	...
	db.addAof(utils.ToMergeCmdLine("append", args...))
...
func execSetRange(db *DB, args [][]byte) resp.Reply {
	...
	db.addAof(utils.ToMergeCmdLine("setRange", args...))
