...
func TestInsertStmt(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			wantSQL: "INSERT INTO `OrmUser`(`CreateTime`,`UpdateTime`,`Id`,`NickName`,`Age`) VALUES(?,?,?,?,?);",
		},
		{
		...
		},
		{
			...
			entity: Seller{User: OrmUser{}},
			// 顺便测试一下单个字段
			wantArgs: []interface{}{OrmUser{}},
			wantSQL:  "INSERT INTO `Seller`(`OrmUser`) VALUES(?);",
		},
	}
