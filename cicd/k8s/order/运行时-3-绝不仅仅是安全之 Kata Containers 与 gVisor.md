### 绝不仅仅是安全之 Kata Containers 与 gVisor
在讲解 CRI 的诞生背景时，提到过这其中的一个重要推动力，就是基于虚拟化或者独立内核的安全容器项目的逐渐成熟。
...
![KataContainers工作原理](image/KataContainers工作原理.png)
...
![Kata Containers 的实现方式](image/KataContainers的实现方式.png)
...
![gVisor 的设计](image/gVisor的设计.png)
...
![gVisor 工作的核心](image/gVisor工作的核心.png)
...
![gVisor工作的核心](image/gVisor工作的核心v2.png)
...
有兴趣的话，你可以在 [这里查看这个演讲](https://lc32018.sched.com/event/ER8x/run-linux-kernel-as-a-daemon-lai-jiangshan-hypersh) 。我相信，这个方向，应该才是安全容器进化的未来。这比 Unikernels 这种根本不适合实际场景中使用的思路，要靠谱得多。
